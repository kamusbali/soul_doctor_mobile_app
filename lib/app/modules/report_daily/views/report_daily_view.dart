                  ...
                  children: [
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // ),
                          // TextFormField(
                          //   controller: controller.heteroanamnesisController,
                          //   validator: (value) =>
                          //       Validators.onNotEmptyValidation(
                          //         value,
                          //         "Heteroanamnesis",
                    ...
                    Form(
                      ...
                      child: Column(
                        spacing: SpacingTheme.SPACING_8,
                        children: [
                          if (controller.reportDailySettings.patientId == null)
                            AsyncDropdownTextField<Patient>(
                              childWidget: (data) => Padding(
                                padding: const EdgeInsets.all(16.0),
                                child: Text(data.name),
                          ...
                          Obx(
                            () => StaticDropdownTextField<bool>(
                              ...
                              decoration: InputDecoration(
                                ...
                                filled: true,
                                errorText: controller.sideEffectErrorText.value,
                                fillColor: ColorTheme.NEUTRAL_100,
                          ...
                          Obx(
                            () => StaticDropdownTextField<VisitResultStatus>(
                              controller:
                                  controller.visitResultStatusController,
                              decoration: InputDecoration(
                                border: OutlineInputBorder(),
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                ...
                                filled: true,
                                errorText:
                                    controller.visitResultStatusErrorText.value,
                                fillColor: ColorTheme.NEUTRAL_100,
                                alignLabelWithHint: true,
                              ),
                              childWidget: (data) => Padding(
                              ...
                              onSelectData:
                                  controller.onChangeVisitResultStatusValue,
                          ...
                          Obx(
                            () => StaticDropdownTextField<AfterSleepCondition>(
                              controller:
                                  controller.afterSleepConditionController,
                              decoration: InputDecoration(
                                border: OutlineInputBorder(),
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                              ...
                              onSelectData:
                                  controller.onChangeAfterSleepConditionValue,
                              onSetTextFieldLabel: (afterSleepCondition) {
                          ...
                          Obx(
                            () => StaticDropdownTextField<MedicineCondition>(
                              controller:
                                  controller.medicineConditionController,
                              decoration: InputDecoration(
                                border: OutlineInputBorder(),
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                ...
                                filled: true,
                                errorText:
                                    controller.medicineConditionErrorText.value,
                                fillColor: ColorTheme.NEUTRAL_100,
                                alignLabelWithHint: true,
                              ),
                              childWidget: (data) => Padding(
                              ...
                              onSelectData:
                                  controller.onChangeMedicineConditionValue,
                          ...
                          Obx(
                            () => StaticDropdownTextField<SelfCare>(
                              ...
                              decoration: InputDecoration(
                                ...
                                filled: true,
                                errorText: controller.selfCareErrorText.value,
                                fillColor: ColorTheme.NEUTRAL_100,
                                alignLabelWithHint: true,
                              ),
                              childWidget: (data) => Padding(
                              ...
                              onSelectData: controller.onChangeSelfCareValue,
                          ...
                          Obx(
                            () => StaticDropdownTextField<bool>(
                              controller: controller.doingCeremonyController,
                              decoration: InputDecoration(
                                border: OutlineInputBorder(),
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                          ...
                          Obx(
                            () => StaticDropdownTextField<PemuputUpacara>(
                              controller: controller.pemuputUpacaraController,
                              decoration: InputDecoration(
                                border: OutlineInputBorder(),
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                ...
                                filled: true,
                                errorText:
                                    controller.pemuputUpacaraErrorText.value,
                                fillColor: ColorTheme.NEUTRAL_100,
                                alignLabelWithHint: true,
                              ),
                              childWidget: (data) => Padding(
                                  ...
                                  .map(
                                    (e) => Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            controller.onDeletePicture(e.key);
                                          },
                                          child: Icon(
