...
class DiagnosisFormView extends GetView<DiagnosisFormController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      switch (controller.diagnosisStatus.value.status) {
        case Status.loading:
        ...
        default:
          return Scaffold(
                  ...
                  child: Column(
                    children: [
                      TextFormField(
                        ...
                        validator: (value) =>
                            Validators.onNotEmptyValidation(value, "Diagnosa"),
                      ...
                      SizedBox(height: SpacingTheme.SPACING_8),
                      TextFormField(
                        controller: controller.therapyController,
                        decoration: InputDecoration(
                          border: OutlineInputBorder(),
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
            ...
            bottomNavigationBar: Padding(
              ...
              child: FilledButton(
                onPressed: controller.onCreateDiagnosis,
